...
<html lang="en">
    <head>
        ...
        <title>@lang('label.SAFE_CARE')</title>
        ...
        <!-- Start :: Treant JS -->
        <link href="{{asset('public/js/treant-js-master/Treant.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('public/js/treant-js-master/vendor/perfect-scrollbar/perfect-scrollbar.css')}}" rel="stylesheet" type="text/css" />
        <!-- End :: Treant JS -->
    </head>
    <!-- END HEAD -->