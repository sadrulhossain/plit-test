...
<div class="col-md-12">
    <div class="portlet box green">
        ...
        <div class="portlet-body form">
            <div class="form-body">
                {!! Form::open(['group' => 'form', 'url' => '', 'class' => 'form-horizontal', 'files' => true, 'id' => 'productCreateForm']) !!}
                {!! Form::hidden('filter', Helper::queryPageStr($qpArr)) !!}
                {{ csrf_field() }}
                {!! Form::hidden('variant_product', 0) !!}
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="skuSection">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::text('sku', null, ['id' => 'skuCode', 'class' => 'form-control', 'autocomplete' => 'off', 'readonly']) !!}
                                ...
                                <!--                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        {!! Form::text('selling_price', null, ['id' => 'sellingPrice', 'class' => 'form-control integer-decimal-only text-right', 'autocomplete' => 'off', 'placeholder' => '0.00']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group bootstrap-touchspin width-full">
                                            {!! Form::text('purchase_price', null, ['id' => 'purchasePrice', 'class' => 'form-control integer-decimal-only text-right', 'autocomplete' => 'off', 'step' => 'any', 'placeholder' => '0.00']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group bootstrap-touchspin width-full">
                                            {!! Form::text('selling_price', null, ['id' => 'retailerPrice', 'class' => 'form-control integer-decimal-only text-right', 'autocomplete' => 'off', 'step' => 'any', 'placeholder' => '0.00']) !!}
                                            <span class="input-group-addon bootstrap-touchspin-postfix bold"> @lang('label.TK')</span>
                                        </div>
                                        <span class="text-danger">{{ $errors->first('selling_price') }}</span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group bootstrap-touchspin width-full">
                                            {!! Form::text('distributor_price', null, ['id' => 'distributorPrice', 'class' => 'form-control integer-decimal-only text-right', 'autocomplete' => 'off', 'step' => 'any', 'placeholder' => '0.00']) !!}
                                            <span class="input-group-addon bootstrap-touchspin-postfix bold"> @lang('label.TK')</span>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group bootstrap-touchspin width-full">
                                            {!! Form::text('discount_price', null, ['id' => 'discountPrice', 'class' => 'form-control integer-decimal-only text-right', 'autocomplete' => 'off', 'step' => 'any', 'placeholder' => '0.00']) !!}
                                            <span class="input-group-addon bootstrap-touchspin-postfix bold"> @lang('label.TK')</span>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::text('reorder_level', null, ['id' => 'reorderLevel', 'class' => 'form-control integer-decimal-only text-right', 'autocomplete' => 'off']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('lot_size', null, ['id' => 'lotSize', 'class' => 'form-control integer-decimal-only text-right', 'autocomplete' => 'off', 'step' => 'any', 'placeholder' => '']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('lot_ratio', '', ['id' => 'lotRatio', 'class' => 'form-control ', 'autocomplete' => 'off']) !!}
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-4 col-md-8">
                            ...
                            <a href="{{ URL::to('/admin/product' . Helper::queryPageStr($qpArr)) }}"
