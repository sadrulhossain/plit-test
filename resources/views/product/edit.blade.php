                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::textarea('description', $targetDetail->description ?? null, ['id' => 'description', 'class' => 'form-control', 'cols' => '20', 'rows' => '3']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::textarea('features', $targetDetail->features ?? null, ['id' => 'features', 'class' => 'form-control', 'cols' => '20', 'rows' => '3']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('image_url', $targetDetail->image_url ?? null, ['id'=> 'imageUrl', 'class' => 'form-control']) !!} 
